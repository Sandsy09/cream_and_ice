            ...
            <div className="mt-6">
                ...
                <div className="flex flex-col items-center md:flex-row justify-between px-6 mt-3 md:mt-4 text-white/50">
                    ...
                    <div className="flex flex-wrap justify-center space-x-4">
                        <NavLink className='hover:text-white transition-colors duration-300' to="/">Home</NavLink>
                        <NavLink className='hover:text-white transition-colors duration-300' to="/flavors">Flavors</NavLink>
                        <NavLink className='hover:text-white transition-colors duration-300' to="/catering">Catering</NavLink>
                        <NavLink className='hover:text-white transition-colors duration-300' to="/locations">Locations</NavLink>
                        <NavLink className='hover:text-white transition-colors duration-300' to="/careers">Careers</NavLink>
                    </div>
                </div>
            </div>
